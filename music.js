$(function(){
    ...
    $musictype.on("click","a",function(){
    	...
    	var type = $(this).data("type"),
    	    url = "http://tingapi.ting.baidu.com/v1/restserver/ting?format=json&callback=?&from=webapp_music&method=baidu.ting.billboard.billList&size=10&type="+type;
    	    that = this;
	...
	function initialList(){
		var url = "http://tingapi.ting.baidu.com/v1/restserver/ting?format=json&callback=?&from=webapp_music&method=baidu.ting.billboard.billList&type=1&size=10&offset=0";
		$.getJSON(url,function(data){
			var song_list  = data.song_list;
			if(song_list){
				showList(song_list);
